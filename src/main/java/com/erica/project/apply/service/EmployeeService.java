...
public interface EmployeeService {
    ...
    List<Response_JobPostDto> getJobPostsByLocation(String location, String username);

    //공고글에 신청하는(지원서작성) 기능(Application생성후 저장) (username을 통해서, Employee객체를 얻고, 이걸 이용해 Application생성)
    Application applyJobPost(Long jobPost_id, String username) throws UserNotFoundException, AlreadyApplyException;
